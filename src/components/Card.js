...
const Card = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-4">
            <div className="max-w-xl mx-auto bg-white dark:bg-dark-blue rounded-xl shadow-md overflow-hidden mt-20 hover:shadow-lg hover:shadow-green duration-300 shadow-cyan">
            ...
            <div className="max-w-xl mx-auto bg-white dark:bg-dark-blue rounded-xl shadow-md overflow-hidden mt-20 hover:shadow-lg hover:shadow-green duration-300 shadow-red">
